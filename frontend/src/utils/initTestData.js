...
// 管理员token
const adminToken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIiwiZW1haWwiOiJhZG1pbkBleGFtcGxlLmNvbSIsInJvbGUiOiJBRE1JTiIsImV4cCI6MTc0ODQwMzAyMiwiaWF0IjoxNzQ4MzE2NjIyfQ.rVmX5x5baICmiqVPDCLe8Ghuwk5mrNL7kQ8uh3_Ai4Y";
...
module.exports = {
  ...
  getMockProductsBySearch: (searchTerm) => {
  ...
  getMockProductsSorted: (sortBy, sortDirection) => {
